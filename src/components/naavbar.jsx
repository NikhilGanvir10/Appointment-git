        ...
        <div className='flex items-center gap-4'> 
            {
                ...
                <div className='absolute top-0 right-0 pt-8 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
                     <div className='min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4'>
                        ...
                        <p onClick={()=> auth.signOut()} className='hover:text-black cursor-pointer'>Logout</p>
                     </div>
                </div>
            ...
            <img onClick={()=> handle} className='w-6 md:hidden ' src={assets.menu_icon} alt="" />

            <div className={` ${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
                <div className='flex items-center justfy-between px-5 py-6'>
                ...
                <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
                    ...
                    <NavLink  onClick={()=> setShowMenu(false)} to='/doct'><p className='px-4 py-2 rounded inline-block'>ALL DOCTORS</p></NavLink>
